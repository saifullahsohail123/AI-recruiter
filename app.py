...
def main():
    ...
    if selected == "Upload Resume":
        ...
        st.header("ℹ️ About AI Recruiter Agency")
        st.markdown("""
        This AI-powered recruitment assistant helps match candidates with suitable job positions.
        
        **Features:**
        - 📄 Resume parsing and skill extraction
        - 🎯 Intelligent job matching based on qualifications
        - 👥 Candidate screening and evaluation
        - 💡 Personalized recommendations
        
        **Powered by:**
        - Ollama LLM for AI processing
